  ...
  return (
    <React.Fragment>
      <span className="navbar-show">
        ...
        >
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-up" role="img" viewBox="0 0 448 512">
        ...
        >
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bars" role="img" viewBox="0 0 448 512">
